...
class UserControllerTest {
    ...
    void whenGetAnUserById_thenReturnJson() throws Exception {
        //Given
        User userTest = new User(1L,"Username","David", LocalDate.parse("2004-09-25"),new ArrayList<>());
    ...
    void whenAddAnUserWithUsernameAlreadyTaken_thenThrowConflict() throws Exception {
        //Given
        User userTest = new User(1L,"Username","David", LocalDate.parse("2004-09-25"),new ArrayList<>());
        User userTestException = new User(2L,"Username","Francisco", LocalDate.parse("2000-08-24"),new ArrayList<>());
